...
@Suite("Money Movement Service")
struct MoneyMovementServiceTests {
    // MARK: - Money Movements (all)

    @Test("Returns all money movements when request succeeds")
    func moneyMovementsReturnsMovementsWhenRequestSucceeds() async throws {
    ...
    @Test("Throws error when fetching all money movements fails")
    func moneyMovementsThrowsErrorWhenRequestFails() async {
    ...
    @Test("Returns money movements for a specific month when request succeeds")
    func moneyMovementsByMonthReturnsMovementsWhenRequestSucceeds() async throws {
        let expectedMovement = MoneyMovement(
            id: "id",
            month: "2024-01-01",
            movedAt: nil,
    ...
    @Test("Throws error when fetching money movements by month fails")
    func moneyMovementsByMonthThrowsErrorWhenRequestFails() async {
        let expectedError = SwiftYNABError.httpError(statusCode: 500)
        let client = MockFailureClient(expectedError: expectedError)
        let service = MoneyMovementService(client: client)
    ...
    @Test("Returns all money movement groups when request succeeds")
    func moneyMovementGroupsReturnsGroupsWhenRequestSucceeds() async throws {
    ...
    @Test("Throws error when fetching all money movement groups fails")
    func moneyMovementGroupsThrowsErrorWhenRequestFails() async {
        let expectedError = SwiftYNABError.httpError(statusCode: 500)
        let client = MockFailureClient(expectedError: expectedError)
        let service = MoneyMovementService(client: client)
    ...
    @Test("Returns money movement groups for a specific month when request succeeds")
    func moneyMovementGroupsByMonthReturnsGroupsWhenRequestSucceeds() async throws {
        let expectedGroup = MoneyMovementGroup(
            id: "id",
            groupCreatedAt: "2024-01-01T12:00:00Z",
            month: "2024-01-01",
    ...
    @Test("Throws error when fetching money movement groups by month fails")
    func moneyMovementGroupsByMonthThrowsErrorWhenRequestFails() async {
        let expectedError = SwiftYNABError.httpError(statusCode: 500)
        let client = MockFailureClient(expectedError: expectedError)
        let service = MoneyMovementService(client: client)
