...
struct CategoryServiceTests {
    ...
    func categoryReturnsCategoryWhenRequestSucceeds() async throws {
        let expectedCategory = Category(
            ...
            balanceCurrency: nil,
            activityFormatted: nil,
            activityCurrency: nil,
            budgetedFormatted: nil,
            budgetedCurrency: nil,
            goalType: nil,
            ...
            goalTarget: nil,
            goalTargetFormatted: nil,
            goalTargetCurrency: nil,
            goalTargetMonth: nil,
            goalTargetDate: nil,
            goalPercentageComplete: nil,
            goalMonthsToBudget: nil,
            goalUnderFunded: nil,
            goalUnderFundedFormatted: nil,
            goalUnderFundedCurrency: nil,
            goalOverallFunded: nil,
            goalOverallFundedFormatted: nil,
            goalOverallFundedCurrency: nil,
            goalOverallLeft: nil,
            goalOverallLeftFormatted: nil,
            goalOverallLeftCurrency: nil,
            goalSnoozedAt: nil,
            deleted: false
        )
