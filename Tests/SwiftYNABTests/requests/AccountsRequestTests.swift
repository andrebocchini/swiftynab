...
@Suite("Accounts Request")
struct AccountsRequestTests {
    @Test("Request omits query when no server knowledge provided")
    func accountsNoQuery() {
        let request = AccountsRequest(planId: "43dcbde6-ccf4-4367-9d13-d6d7e9beeb99")
