...
@Suite("Payees Request")
struct PayeesRequestTests {
    @Test("Request includes last knowledge of server query parameter")
    func payeesRequestWithKnowledge() {
    ...
    func payeesRequestNoKnowledge() {
        let request = PayeesRequest(planId: "43dcbde6-ccf4-4367-9d13-d6d7e9beeb99")
        #expect(request.path == "/v1/plans/43dcbde6-ccf4-4367-9d13-d6d7e9beeb99/payees")
        #expect(request.method == .get)
