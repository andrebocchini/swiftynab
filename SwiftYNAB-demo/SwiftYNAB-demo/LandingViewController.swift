...
class LandingViewController: UIViewController {
    ...
    private func oAuthLogin(completion: @escaping (String?, Error?) -> Void) {
        authSession?.cancel()
        authSession = ASWebAuthenticationSession(url: authUrl, callbackURLScheme: "swiftynab") {
    ...
    private func showPersonalAccessTokenInputAlert(completion: @escaping (String) -> Void) {
        let alert = UIAlertController(
            ...
            message: "Enter your YNAB API personal token",
    ...
    @IBAction func personalTokenButtonTapped(_: Any) {
    ...
    @IBAction func oAuthLoginButtonTapped(_: Any) {
        oAuthLogin {
