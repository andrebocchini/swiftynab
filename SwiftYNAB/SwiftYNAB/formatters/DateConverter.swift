...
public class DateConverter {
    ...
    public func budgetFormatDateString(from apiDateString: String) -> String? {
        ...
        return self.budgetDisplayDateFormatter.string(from: inputDate)
    }
    ...
    public static func date(from apiDateString: String) -> Date? {
        return DateConverter.iso8601DateFormatter.date(from: apiDateString)
    }
    ...
    /**
     ...
     - Returns a API-friendly iso8601 date string
     */
